...
const ScheduleCardWidget = ({
  ...
  return (
    <Card className={cn("overflow-hidden shadow-md border border-gray-200 rounded-xl", className)}>
      ...
      <CardContent className="p-0 bg-white">
        ...
        <div className="text-gray-500 px-5 pt-4 pb-3 text-sm font-medium">
          {currentMonth}
        </div>
            ...
            {weekDates.map((date, index) => {
              ...
              return (
                <Button 
                  ...
                  variant="ghost" 
                  className={cn(
                    "flex-col items-center gap-1 rounded-lg border px-0 py-3 w-14",
                    isSelected ? "bg-orange-500 text-white hover:bg-orange-600 border-orange-500" : 
