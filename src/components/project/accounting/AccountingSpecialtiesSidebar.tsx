...
interface AccountingSpecialtiesSidebarProps {
...
const AccountingSpecialtiesSidebar = ({ 
  activeSpecialty, 
  setActiveSpecialty 
}: AccountingSpecialtiesSidebarProps) => {
  return (
...
export default AccountingSpecialtiesSidebar;
