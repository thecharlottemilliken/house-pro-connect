      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
          ...
          field
                ...
                <FormControl>
                  <div className="relative">
                    <Input placeholder="John Doe" className="pl-10 h-12 border-gray-300 rounded-lg" {...field} />
          ...
          field
                ...
                <FormControl>
                  <div className="relative">
                    <Input type="email" placeholder="you@example.com" className="pl-10 h-12 border-gray-300 rounded-lg" {...field} />
          ...
          field
                ...
                <FormControl>
                  <div className="relative">
                    <Input type={showPassword ? "text" : "password"} placeholder="Create a password" className="pl-10 pr-10 h-12 border-gray-300 rounded-lg" {...field} />
          ...
          field
                ...
                <FormControl>
                  <div className="relative">
                    <Input type={showConfirmPassword ? "text" : "password"} placeholder="Confirm your password" className="pl-10 pr-10 h-12 border-gray-300 rounded-lg" {...field} />
                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
          ...
          field
                ...
                <FormControl>
                  <Checkbox checked={field.value} onCheckedChange={field.onChange} className="mt-0.5 data-[state=checked]:bg-[#9b87f5] data-[state=checked]:border-[#9b87f5]" />
                </FormControl>
